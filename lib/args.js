...
const argsOptions = {
  ...
  string: [strategyKey, formatKey, nameKey],
  default: {
...
// $ node chart.js -f jpg -n output data1.txt data2.txt
// $ node chart.js -f jpg data
// $ node chart.js -f jpg data
const usage = `Usage:
    chart [-s strategy] [-f format] [-v] [-h] file1 file2 file2 ... file10
    chart [--s=strategy] [--f=format] [-v] [-h] file1 file2 file2 ... file10
    chart [--s=strategy] [--f=format] [-v] [-h] folder
Where:
  options:
 ...
 * @type {strategy: string, format: string, fileOut: string, files: string[], title?: string} always valid
 */
module.exports = {
  strategy,
  format,
