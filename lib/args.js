...
const argsOptions = {
  ...
  string: [formatKey, nameKey, modeKey],
  default: {
    [verboseKey]: false, // verbose
    [helpKey]: false, // help
    [formatKey]: FORMAT_TYPE.SVG, // format
    [modeKey]: MODE_CHART.QUASI_STATIC_COMPRESSION, // mode
  },
  alias: {
    [helpKey]: 'help',
  },
...
title =
  mode === MODE_CHART.QUASI_STATIC_COMPRESSION
    ? 'Quasi static compression test'
    : '3pt Bending Test';
const credits = 'Etem / Gestamp';
